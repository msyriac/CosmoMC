module ACTPol_CMBonly 
  ...
  like_file    = trim(data_dir)//'cl_cmb_aps2.dat'
  cov_file     = trim(data_dir)//'c_matrix_actpol.dat'
  bbltt_file   = trim(data_dir)//'BblMean.dat'
  bblte_file   = trim(data_dir)//'BblMean_Cross.dat'
  bblee_file   = trim(data_dir)//'BblMean_Pol.dat'
